...
Интересный факт: В 2017 году сквер перед библиотекой был благоустроен, а на его территории появилась цветочная клумба в виде раскрытой книги и литературный арт-объект «Голубь Экзюпери».`,
    ...
    fantasy_info: {
        title: 'Библиотека Гоголя',
      description: `Описание:
Мрачная библиотека в бордовых тонах, окутанная серой дымкой. В интерьере присутствует множество предметов из реального мира, затянутые сюда магией.
...
• У истока реки таится «ключ судьбы», который может приоткрыть тайну проклятия.`,
        image: ohta_fantasy,
    },
    status: 'available',
  },
